...
Welcome to ``pht`` contributor's guide.
...
If you experience bugs or general issues with ``pht``, please have a look
...
You can help improve ``pht`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``pht`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``pht``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n pht python=3 six virtualenv pytest pytest-cov
    conda activate pht
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/pht.git
    cd pht
...
#. Install |pre-commit|_::
   ...
   ``pht`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/pht
.. _issue tracker: https://github.com/<USERNAME>/pht/issues
.. <-- end -->
